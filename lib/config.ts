...
export const PROOFSCORE_V10_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PROOFSCORE_V10_ADDRESS ?? '0x0000000000000000000000000000000000000000'
export const PROOFSCORE_V10_IS_CONFIGURED = /^0x[a-fA-F0-9]{40}$/.test(PROOFSCORE_V10_CONTRACT_ADDRESS) && !/^0x0{40}$/.test(PROOFSCORE_V10_CONTRACT_ADDRESS)
