...
receive a consensus quality verdict. A reward is claimable only after an
`ACCEPTED` verdict meets the published 70/100 threshold.
...
5. Validators independently assess this concise dossier under the fixed rubric:
   functionality (25), meaningful GenLayer integration (30), real-world use
   (20), documentation/reproducibility (15), and originality/reuse (10).
...
quality verdict. The contract gates GEN settlement on those accepted on-chain
...
The quality verdict is a decentralized judgment of the public dossier against
the visible rubric and should be read within that scope. Incomplete evidence
